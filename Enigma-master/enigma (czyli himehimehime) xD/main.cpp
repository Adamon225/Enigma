...
system("cls");
//cout << "Enigma is a game made by Ninja and Adamon." << endl - w podpisach lub na pocz¹tku

//cout << "How to play: There are three difficulty levels. Each level you need to guess 4 to 10 numbers after every try Enigma shows you the number of your correct answers. It's sometimes difficult but don't give up! :D" << endl - opis gry na poczatek w osobnej 4 czesci

//cout << "In this level you need to guess 4 numbers. It's easy don't worry, just think!" << endl-easy pocz.
//cout << "Oh come on! Try again!" << endl - easy przegrana

//cout << "In this level you need to guess . numbers. It's quite difficult, but you need to try! " << endl - normal pocz.
//cout << "Try again, don't worry that was quite hard! :)" << endl - norm. przegrana

//cout << "In this level you need to guess 10 numbers. It's really hard, but not impossible!" << endl - hard pocz.
//cout << "Don't worry, anyone done this before. ;D" << endl - hard przegrana
cout << "Choose difficulty:" << endl<<"1:Easy 2.Normal (quite hard) 3.Hard"<<endl;
cin>>difficulty;
